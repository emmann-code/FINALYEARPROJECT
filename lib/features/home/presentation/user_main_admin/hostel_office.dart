// ignore_for_file: prefer_const_constructors_in_immutables, use_build_context_synchronously, deprecated_member_use, unnecessary_to_list_in_spreads
...
class HostelComplaintsPage extends ConsumerStatefulWidget {
  const HostelComplaintsPage({super.key});

  @override
  ConsumerState<HostelComplaintsPage> createState() =>
      _HostelComplaintsPageState();
}

class _HostelComplaintsPageState extends ConsumerState<HostelComplaintsPage>
  ...
  final List<Map<String, String>> faqs = [
    ...
    },
    {
      ...
      "answer":
          "Submit a hostel application form to the Hostel Office along with required documents and payment."
    },
    {
      "question": "What are the hostel rules and regulations?",
      "answer":
          "Hostel rules are available in the student handbook and posted in common areas. Follow them to maintain a peaceful environment."
    },
    {
      "question": "How do I report maintenance issues?",
      "answer":
          "Report maintenance issues to the hostel office or use the maintenance request form available online."
    },
    {
      "question": "What are the hostel fees and payment schedule?",
      "answer":
          "Hostel fees are payable at the beginning of each semester. Check the finance office for current rates."
    },
    {
      "question": "How do I request a room change?",
      "answer":
          "Submit a room change request form to the hostel office. Changes are subject to availability."
    },
    {
      "question": "What facilities are available in the hostel?",
      "answer":
          "Hostel facilities include dining halls, laundry rooms, study areas, and recreational spaces."
    },
    {
      "question": "How do I access the hostel after hours?",
      "answer":
          "Late entry requires prior permission from the hostel office. Follow security protocols."
    },
    {
      "question": "What should I do in case of an emergency?",
      "answer":
          "Contact the hostel office immediately or call the emergency number posted in the hostel."
    },
    {
      "question": "How do I check out of the hostel?",
      "answer":
          "Submit a checkout form to the hostel office and return all keys and equipment."
    },
  ];
        ...
        child: SafeArea(
          ...
          child: Column(
            children: [
                        ...
                        SizedBox(height: 8),
                        Text(
                          'We\'re here to help resolve your hostel concerns',
                          style: GoogleFonts.poppins(
                            fontSize: 14,
                            color: isDarkMode
