// ignore_for_file: unused_element, use_build_context_synchronously, deprecated_member_use, unnecessary_to_list_in_spreads
...
class HealthcareComplaintsPage extends ConsumerStatefulWidget {
  const HealthcareComplaintsPage({super.key});

  @override
  ConsumerState<HealthcareComplaintsPage> createState() =>
      _HealthcareComplaintsPageState();
}

class _HealthcareComplaintsPageState
    extends ConsumerState<HealthcareComplaintsPage>
  ...
  final List<Map<String, String>> faqs = [
    ...
    {
      "question": "What services are available at the healthcare center?",
      "answer":
          "The healthcare center provides medical consultations, emergency care, mental health support, vaccinations, and health screenings."
    },
    {
      "question": "How do I schedule an appointment?",
      "answer":
          "Appointments can be scheduled by calling the healthcare center or visiting in person during office hours."
    },
    {
      "question": "Is there emergency care available?",
      "answer":
          "Yes, emergency care is available 24/7 for urgent medical situations."
    },
    {
      "question": "What mental health services are offered?",
      "answer":
          "Mental health services include counseling, therapy sessions, and support groups for students."
    },
    {
      "question": "Are vaccinations provided free of charge?",
      "answer":
          "Some vaccinations are free for students, while others may require a small fee. Check with the healthcare center for details."
    },
    {
      "question": "How do I access my medical records?",
      "answer":
          "Medical records can be accessed by requesting them from the healthcare center's administrative office."
    },
    {
      "question": "What should I do in case of a medical emergency?",
      "answer":
          "In case of a medical emergency, call the emergency number or visit the healthcare center immediately."
    },
    {
      "question": "Are there health education programs available?",
      "answer":
          "Yes, the healthcare center regularly conducts health education programs and workshops for students."
    },
    {
      "question": "How do I report a health-related incident?",
      "answer":
          "Health-related incidents can be reported to the healthcare center staff or through the university's incident reporting system."
    },
  ];
        ...
        child: SafeArea(
          ...
          child: Column(
            children: [
                        ...
                        SizedBox(height: 8),
                        Text(
                          'We\'re here to help resolve your health concerns',
                          style: GoogleFonts.poppins(
                            fontSize: 14,
                            color: isDarkMode
