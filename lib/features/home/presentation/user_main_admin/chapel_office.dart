...
class ChapelComplaintsPage extends ConsumerStatefulWidget {
  const ChapelComplaintsPage({super.key});

  @override
  ConsumerState<ChapelComplaintsPage> createState() =>
      _ChapelComplaintsPageState();
}

class _ChapelComplaintsPageState extends ConsumerState<ChapelComplaintsPage>
  ...
  final List<Map<String, String>> faqs = [
    ...
    {
      "question": "What are the chapel service times?",
      "answer":
          "Chapel services are held on Sundays at 10:00 am and Wednesdays at 4:30 pm plus daily Morning devotions."
    },
    {
      "question": "How can I volunteer for chapel services?",
      "answer":
          "Contact the Chapel Office to sign up for volunteering opportunities during services."
    },
    {
      "question": "Is there a chapel choir?",
      "answer":
          "Yes, the chapel has a choir. Interested students can join by contacting the Chapel Office."
    },
    {
      "question": "How can I schedule a meeting with the chaplain?",
      "answer":
          "Appointments can be made by contacting the Chapel Office directly."
    },
    {
      "question": "Are there any Bible study groups?",
      "answer":
          "Yes, the Chapel Office organizes Bible study groups. Inquire at the office for meeting times."
    },
    {
      "question": "Can I host a religious event in the chapel?",
      "answer":
          "To host an event, request approval from the Chapel Office, providing necessary details."
    },
    {
      "question": "What events are organized by the chapel?",
      "answer":
          "The chapel organizes regular prayer meetings, religious conferences, and fellowship gatherings."
    },
    {
      "question": "How do I donate to the chapel?",
      "answer":
          "Donations can be made directly at the Chapel Office or via the university's online donation portal."
    },
    {
      "question": "Are there any prayer rooms on campus?",
      "answer":
          "The Chapel Office provides information on available prayer rooms on campus."
    },
    {
      "question": "What is the chapel's role in student life?",
      "answer":
          "The chapel supports spiritual growth through services, counseling, and community activities."
    }
  ];
        ...
        child: SafeArea(
          ...
          child: Column(
            children: [
                        ...
                        SizedBox(height: 8),
                        Text(
                          'We\'re here to help resolve your chapel concerns',
                          style: GoogleFonts.poppins(
                            fontSize: 14,
                            color: isDarkMode
