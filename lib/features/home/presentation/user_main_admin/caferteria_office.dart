...
class CafeteriaComplaintsPage extends ConsumerStatefulWidget {
  const CafeteriaComplaintsPage({super.key});

  @override
  ConsumerState<CafeteriaComplaintsPage> createState() =>
      _CafeteriaComplaintsPageState();
}

class _CafeteriaComplaintsPageState
    extends ConsumerState<CafeteriaComplaintsPage>
  ...
  final List<Map<String, String>> faqs = [
    ...
    {
      "question": "What are the cafeteria meal times?",
      "answer":
          "Meals are served from 7:00 am to 9:00 pm daily. Specific times for breakfast, lunch, and dinner vary."
    },
    {
      "question": "Can I suggest a new meal to the cafeteria menu?",
      "answer":
          "Yes, students can submit meal suggestions to the Cafeteria Office for consideration."
    },
    {
      "question": "How do I pay for meals?",
      "answer":
          "Meals can be paid for using cash, meal cards, or the student payment system."
    },
    {
      "question": "Is there a vegetarian option in the cafeteria?",
      "answer": "Yes, the cafeteria provides vegetarian and vegan meal options."
    },
    {
      "question": "How do I apply for a meal plan?",
      "answer":
          "Meal plan applications can be submitted to the Cafeteria Office at the beginning of the semester."
    },
    {
      "question": "Are there any discounts for students?",
      "answer":
          "The cafeteria offers discounts for students who purchase meal plans or bulk meal tickets."
    },
    {
      "question": "Is the cafeteria open on holidays?",
      "answer":
          "The cafeteria operates with limited hours on holidays. Check with the Cafeteria Office for specific schedules."
    },
    {
      "question": "Can I order food for an event?",
      "answer":
          "Yes, catering services are available for events. Contact the Cafeteria Office for more details."
    },
    {
      "question": "What is the cafeteria's policy on food allergies?",
      "answer":
          "The cafeteria provides information on allergens in food. Inform staff about allergies when ordering."
    },
    {
      "question": "How do I become a cafeteria staff member?",
      "answer":
          "Students can apply for part-time positions at the Cafeteria Office."
    }
  ];
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 8),
                        Text(
                          'We\'re here to help resolve your cafeteria concerns',
                          style: GoogleFonts.poppins(
                            fontSize: 14,
                            color: isDarkMode
