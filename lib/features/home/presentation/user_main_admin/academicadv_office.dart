// ignore_for_file: use_build_context_synchronously, deprecated_member_use, sized_box_for_whitespace, unnecessary_to_list_in_spreads
...
class AcademicAdvisoryComplaintsPage extends ConsumerStatefulWidget {
  const AcademicAdvisoryComplaintsPage({super.key});

  @override
  ConsumerState<AcademicAdvisoryComplaintsPage> createState() =>
      _AcademicAdvisoryComplaintsPageState();
}

class _AcademicAdvisoryComplaintsPageState
    extends ConsumerState<AcademicAdvisoryComplaintsPage>
  ...
  final List<Map<String, String>> faqs = [
    ...
    },
    {
      ...
      'answer': 'Yes, you will be notified via email or in app.'
    },
    {
      'question': 'How do I contact my academic advisor?',
      'answer':
          'You can contact your academic advisor through the department or send your complaint via mtu conecthub or via email.'
    },
    {
      'question':
          'What should I do if I feel my academic advisor is not responding?',
      'answer':
          'Please escalate the issue by contacting the academic office directly.'
    },
    {
      'question': 'How can I change my assigned academic advisor?',
      'answer':
          'To request a change, please reach out to the Academic Affairs department.'
    },
    {
      'question': 'What types of academic issues can be raised in a complaint?',
      'answer':
          'You can raise concerns related to course content, advisor support, or academic resources.'
    },
    {
      'question':
          'Can I request an extension on an assignment due to academic advising issues?',
      'answer':
          'Yes, extensions can be requested based on valid academic advisory issues; please provide documentation.'
    },
    {
      'question':
          'How can I get support for academic planning and course selection?',
      'answer':
          'Contact your academic advisor or schedule an appointment with the advising office.'
    },
    {
      'question':
          'How long should I expect to wait for a response to my academic complaint?',
      'answer':
          'Responses typically take 5-7 business days depending on the complexity of the issue.'
    },
    {
      'question':
          'Can I submit a complaint if I\'m unsatisfied with my advisor\'s guidance on career prospects?',
      'answer':
          'Yes, career advising concerns can be raised with the Academic Affairs office.'
    },
    {
      'question': 'What happens after I submit an academic complaint?',
      'answer':
          'Your complaint will be reviewed by the appropriate department and you will be notified of the next steps.'
    },
  ];
 ...
 Future<String> _uploadImageToFirebase() async {
  ...
  Future<void> _submitComplaint() async {
    ...
    await FirebaseFirestore.instance
        .collection('AcademicAdvisoryComplaints')
        .add({
        ...
        child: SafeArea(
          ...
          child: Column(
            children: [
                        ...
                        SizedBox(height: 8),
                        Text(
                          'We\'re here to help resolve your academic concerns',
                          style: GoogleFonts.poppins(
                            fontSize: 14,
                            color: isDarkMode
