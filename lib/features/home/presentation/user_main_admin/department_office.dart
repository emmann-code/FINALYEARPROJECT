...
class DepartmentComplaintsPage extends ConsumerStatefulWidget {
  const DepartmentComplaintsPage({super.key});

  @override
  ConsumerState<DepartmentComplaintsPage> createState() =>
      _DepartmentComplaintsPageState();
}

class _DepartmentComplaintsPageState
    extends ConsumerState<DepartmentComplaintsPage>
  ...
  final List<Map<String, String>> faqs = [
    ...
    },
    {
      ...
      "answer":
          "Course registration is done online through the university's student portal. Ensure you meet the prerequisites before registering."
    },
    {
      "question": "What is the procedure for changing my course?",
      "answer":
          "To change a course, submit a completed course change form to the Department Office within the first two weeks of the semester."
    },
    {
      "question": "How do I apply for a leave of absence?",
      "answer":
          "Complete the leave of absence form and submit it to the Department Office for approval."
    },
    {
      "question": "Where can I find my academic transcript?",
      "answer":
          "Academic transcripts can be requested through the Department Office or the Registrar's Office."
    },
    {
      "question": "How do I appeal a grade?",
      "answer":
          "Submit a formal grade appeal letter to the Department Office within one month after the grades are released."
    },
    {
      "question": "What are the graduation requirements?",
      "answer":
          "Graduation requirements include completing all required courses, achieving a minimum CGPA, and fulfilling any departmental mandates."
    },
    {
      "question": "How can I obtain a recommendation letter?",
      "answer":
          "Request a recommendation letter from your academic advisor or department head, providing necessary details about your achievements."
    },
    {
      "question": "What is the process for transferring between departments?",
      "answer":
          "Department transfer applications are reviewed based on academic performance and availability of space. Submit your application to the Department Office."
    },
    {
      "question": "How do I access past examination papers?",
      "answer":
          "Past examination papers are available in the Department Office or the university's digital repository."
    },
    {
      "question": "Who do I contact for academic advising?",
      "answer":
          "Contact your assigned academic advisor or the Department Office for guidance."
    }
  ];
      ...
      decoration: BoxDecoration(
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
          ...
          _buildModernTextField(
              "Full Name", nameController, Icons.person_outline, isDarkMode),
          SizedBox(height: 16),
