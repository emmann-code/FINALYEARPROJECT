...
class FinanceComplaintsPage extends ConsumerStatefulWidget {
  const FinanceComplaintsPage({super.key});

  @override
  ConsumerState<FinanceComplaintsPage> createState() =>
      _FinanceComplaintsPageState();
}

class _FinanceComplaintsPageState extends ConsumerState<FinanceComplaintsPage>
  ...
  final List<Map<String, String>> faqs = [
    ...
    },
    {
      ...
      "answer":
          "Tuition fees can be paid through the university's online payment portal or at designated bank branches."
    },
    {
      "question": "What financial aid options are available?",
      "answer":
          "The university offers scholarships, grants, and loans. Apply through the Financial Aid section on the student portal."
    },
    {
      "question": "How can I check my account balance?",
      "answer":
          "Log in to your student account on the finance portal to view your balance and transaction history."
    },
    {
      "question": "What should I do if I am facing financial difficulties?",
      "answer":
          "Contact the Financial Aid office for counseling and assistance options."
    },
    {
      "question": "How do I apply for a payment plan?",
      "answer":
          "Submit a payment plan application through the finance portal or by contacting the finance office directly."
    },
    {
      "question": "Are there any emergency funds available for students?",
      "answer":
          "Emergency funds are available on a case-by-case basis. Apply through the Financial Aid office."
    },
    {
      "question": "How do I receive refunds for overpaid fees?",
      "answer":
          "Refunds are processed through the finance office. Submit a refund request form available on the finance portal."
    },
    {
      "question": "Can I get a copy of my financial statements?",
      "answer":
          "Financial statements can be downloaded from your finance portal account or requested from the finance office."
    },
    {
      "question": "What scholarships are available for incoming students?",
      "answer":
          "Information on scholarships for new students is available on the admissions page of the university website."
    },
  ];
        ...
        child: SafeArea(
          ...
          child: Column(
            children: [
                        ...
                        SizedBox(height: 8),
                        Text(
                          'We\'re here to help resolve your financial concerns',
                          style: GoogleFonts.poppins(
                            fontSize: 14,
                            color: isDarkMode
