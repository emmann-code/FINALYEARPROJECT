...
class ITSupportComplaintsPage extends ConsumerStatefulWidget {
  const ITSupportComplaintsPage({super.key});

  @override
  ConsumerState<ITSupportComplaintsPage> createState() =>
      _ITSupportComplaintsPageState();
}

class _ITSupportComplaintsPageState
    extends ConsumerState<ITSupportComplaintsPage>
  ...
  final List<Map<String, String>> faqs = [
    ...
    },
    {
      ...
      "answer":
          "Visit the IT Support office or use the online password reset portal with your student ID."
    },
    {
      "question": "What should I do if I can't access the student portal?",
      "answer":
          "Contact the IT Support office immediately. They can help troubleshoot access issues."
    },
    {
      "question": "How do I connect to the university WiFi?",
      "answer":
          "Use your student credentials to connect to the university WiFi network. Contact IT Support if you encounter issues."
    },
    {
      "question": "What software is available in the computer labs?",
      "answer":
          "Computer labs have various software including Microsoft Office, programming tools, and specialized academic software."
    },
    {
      "question": "How do I report a computer lab issue?",
      "answer":
          "Report issues to the lab supervisor or contact the IT Support office directly."
    },
    {
      "question": "Can I get help with my personal device?",
      "answer":
          "IT Support can help with university-related software and network connectivity issues on personal devices."
    },
    {
      "question": "How do I access my university email?",
      "answer":
          "Access your university email through the student portal or email client using your student credentials."
    },
    {
      "question": "What should I do if my account is locked?",
      "answer":
          "Contact the IT Support office to unlock your account. You may need to provide identification."
    },
    {
      "question": "Are there IT training sessions available?",
      "answer":
          "Yes, IT Support offers training sessions on various software and systems. Check their schedule for upcoming sessions."
    },
  ];
        ...
        child: SafeArea(
          ...
          child: Column(
            children: [
                        ...
                        SizedBox(height: 8),
                        Text(
                          'We\'re here to help resolve your IT concerns',
                          style: GoogleFonts.poppins(
                            fontSize: 14,
                            color: isDarkMode
