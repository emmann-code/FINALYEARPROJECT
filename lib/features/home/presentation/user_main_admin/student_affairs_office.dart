...
class StudentAffairsComplaintsPage extends ConsumerStatefulWidget {
  const StudentAffairsComplaintsPage({super.key});

  @override
  ConsumerState<StudentAffairsComplaintsPage> createState() =>
      _StudentAffairsComplaintsPageState();
}

class _StudentAffairsComplaintsPageState
    extends ConsumerState<StudentAffairsComplaintsPage>
  ...
  final List<Map<String, String>> faqs = [
    ...
    {
      "question": "How do I join a student organization?",
      "answer":
          "Visit the Student Affairs office to get information about available organizations and their registration process."
    },
    {
      "question": "How do I organize a campus event?",
      "answer":
          "Submit an event proposal to the Student Affairs office at least two weeks before the event date."
    },
    {
      "question": "What are my rights as a student?",
      "answer":
          "Student rights are outlined in the student handbook. Contact Student Affairs for specific questions."
    },
    {
      "question": "How do I report a disciplinary issue?",
      "answer":
          "Report disciplinary issues to the Student Affairs office or through the university's reporting system."
    },
    {
      "question": "How can I get involved in student government?",
      "answer":
          "Elections are held annually. Contact Student Affairs for information about candidacy and voting."
    },
    {
      "question": "What community service opportunities are available?",
      "answer":
          "Student Affairs coordinates various community service programs. Check their office for current opportunities."
    },
    {
      "question": "How do I access student life resources?",
      "answer":
          "Student life resources are available through the Student Affairs office and online portal."
    },
    {
      "question": "What orientation programs are offered?",
      "answer":
          "Orientation programs are held at the beginning of each academic year. Contact Student Affairs for schedules."
    },
    {
      "question": "How do I file a grievance?",
      "answer":
          "File grievances through the Student Affairs office using the official grievance form."
    },
  ];
  ...
  Future<void> _submitComplaint() async {
    ...
    await FirebaseFirestore.instance
        .collection('StudentAffairsComplaints')
        .add({
        ...
        child: SafeArea(
          ...
          child: Column(
            children: [
                        ...
                        SizedBox(height: 8),
                        Text(
                          'We\'re here to help resolve your student affairs concerns',
                          style: GoogleFonts.poppins(
                            fontSize: 14,
                            color: isDarkMode
