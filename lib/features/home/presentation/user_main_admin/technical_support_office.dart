...
class TechnicalSupportComplaintsPage extends ConsumerStatefulWidget {
  const TechnicalSupportComplaintsPage({super.key});

  @override
  ConsumerState<TechnicalSupportComplaintsPage> createState() =>
      _TechnicalSupportComplaintsPageState();
}

class _TechnicalSupportComplaintsPageState
    extends ConsumerState<TechnicalSupportComplaintsPage>
  ...
  final List<Map<String, String>> faqs = [
    ...
    {
      "question": "How do I report a hardware malfunction?",
      "answer":
          "Contact the Technical Support office immediately or submit a ticket through the online system."
    },
    {
      "question": "What should I do if my computer won't start?",
      "answer":
          "Check power connections first, then contact Technical Support for assistance."
    },
    {
      "question": "How do I request software installation?",
      "answer":
          "Submit a software installation request through the Technical Support portal or visit their office."
    },
    {
      "question": "What are the office hours for technical support?",
      "answer":
          "Technical Support is available from 8:00 AM to 6:00 PM on weekdays and 9:00 AM to 3:00 PM on weekends."
    },
    {
      "question": "How do I report a network issue?",
      "answer":
          "Report network issues to Technical Support immediately as they may affect multiple users."
    },
    {
      "question": "Can I get help with my personal device?",
      "answer":
          "Technical Support can assist with university-related software and network connectivity on personal devices."
    },
    {
      "question": "How do I schedule a technical training session?",
      "answer":
          "Contact Technical Support to schedule training sessions on various software and systems."
    },
    {
      "question": "What should I do if I can't access university systems?",
      "answer":
          "Contact Technical Support immediately as this may be a system-wide issue."
    },
    {
      "question": "How do I report a security concern?",
      "answer":
          "Report security concerns directly to Technical Support or through the university's security hotline."
    },
  ];
 ...
 Future<String> _uploadImageToFirebase() async {
  ...
  Future<void> _submitComplaint() async {
    ...
    await FirebaseFirestore.instance
        .collection('TechnicalSupportComplaints')
        .add({
        ...
        child: SafeArea(
          ...
          child: Column(
            children: [
                        ...
                        SizedBox(height: 8),
                        Text(
                          'We\'re here to help resolve your technical concerns',
                          style: GoogleFonts.poppins(
                            fontSize: 14,
                            color: isDarkMode
