// ignore_for_file: use_build_context_synchronously, unused_element, prefer_const_constructors_in_immutables, deprecated_member_use, unnecessary_to_list_in_spreads
...
class CollegeComplaintsPage extends ConsumerStatefulWidget {
  CollegeComplaintsPage({super.key});

  @override
  ConsumerState<CollegeComplaintsPage> createState() =>
      _CollegeComplaintsPageState();
}

class _CollegeComplaintsPageState extends ConsumerState<CollegeComplaintsPage>
  ...
  final List<Map<String, String>> faqs = [
    ...
    {
      "question": "How do I apply for inter-university transfer?",
      "answer":
          "Submit an application along with your academic transcripts and other required documents to the College Office."
    },
    {
      "question": "What scholarships are available through the college?",
      "answer":
          "The College Office provides information on scholarships based on merit and need. Inquire about available scholarships each academic year."
    },
    {
      "question": "How can I participate in college events?",
      "answer":
          "Join the college's student council or volunteer for events by contacting the College Office."
    },
    {
      "question": "Where can I find the college's academic calendar?",
      "answer":
          "The academic calendar is available on the university's official website and at the College Office."
    },
    {
      "question": "How do I register for college workshops and seminars?",
      "answer": "Register through the College Office or the event coordinator."
    },
    {
      "question": "What is the process for nominating a student for awards?",
      "answer":
          "Nominations are submitted by faculty members to the College Office, which reviews and forwards them to the awards committee."
    },
    {
      "question": "How can I access college newsletters?",
      "answer":
          "Subscribe to newsletters through the College Office or the university's mailing list."
    },
    {
      "question": "Who do I contact for issues related to college facilities?",
      "answer":
          "Contact the College Office for concerns regarding facilities and maintenance."
    },
    {
      "question": "How do I provide feedback about college services?",
      "answer":
          "Submit feedback forms available at the College Office or through the university's online portal."
    },
    {
      "question": "What are the office hours of the College Office?",
      "answer":
          "The College Office operates from 9:00 am to 4:00 pm, Monday to Friday."
    },
  ];
